...
temp_link = 'https://pulty.tv/product/index/RM-D1006_Philips_HT_DVD_2464'
r = requests.get(temp_link)
encoding = r.encoding if 'charset' in r.headers.get('content-type', '').lower() else None
soup = BeautifulSoup(r.content, "lxml", from_encoding=encoding)

description777 = soup.find(class_="tovar").find_all("h1")
        ...
        for gg in description55:
            for pic in pics:
                ...
                try:
                    ...
                    pult_desriction = description52.text.split(":")[0].strip('\n')
                # pult_desriction = 1
                # print(description52.text.split(":")[0])
